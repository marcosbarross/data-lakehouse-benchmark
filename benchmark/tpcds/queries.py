"""Consultas analíticas completas da suíte TPC-DS (Decision Support) - 99 queries canônicas."""
...
TPCDS_QUERIES: dict[str, str] = {
    ...
    FROM
      (
       SELECT
         '{catalog}.{schema}.store channel' "channel"
    ...
    , "count"(*) "cnt"
    FROM
      {catalog}.{schema}.customer_address a
    , {catalog}.{schema}.customer c
    , {catalog}.{schema}.store_sales s
    , {catalog}.{schema}.date_dim d
    , {catalog}.{schema}.item i
    ...
    FROM
      {catalog}.{schema}.catalog_sales cs1
    , {catalog}.{schema}.date_dim
    , {catalog}.{schema}.customer_address
    , {catalog}.{schema}.call_center
    WHERE ("d_date" BETWEEN CAST('2002-2-01' AS DATE) AND (CAST('2002-2-01' AS DATE) + INTERVAL  '60' DAY))
       ...
       SELECT *
       FROM
         {catalog}.{schema}.catalog_sales cs2
       ...
       SELECT *
       FROM
         {catalog}.{schema}.catalog_returns cr1
    ...
    , {catalog}.{schema}.customer
    , {catalog}.{schema}.customer_address current_addr
    WHERE ("ss_customer_sk" = "c_customer_sk")
    ...
    FROM
      (((((((((({catalog}.{schema}.catalog_sales
    INNER JOIN {catalog}.{schema}.inventory ON ("cs_item_sk" = "inv_item_sk"))
    INNER JOIN {catalog}.{schema}.warehouse ON ("w_warehouse_sk" = "inv_warehouse_sk"))
    INNER JOIN {catalog}.{schema}.item ON ("i_item_sk" = "cs_item_sk"))
    INNER JOIN {catalog}.{schema}.customer_demographics ON ("cs_bill_cdemo_sk" = "cd_demo_sk"))
    INNER JOIN {catalog}.{schema}.household_demographics ON ("cs_bill_hdemo_sk" = "hd_demo_sk"))
    INNER JOIN {catalog}.{schema}.date_dim d1 ON ("cs_sold_date_sk" = "d1"."d_date_sk"))
    INNER JOIN {catalog}.{schema}.date_dim d2 ON ("inv_date_sk" = "d2"."d_date_sk"))
    INNER JOIN {catalog}.{schema}.date_dim d3 ON ("cs_ship_date_sk" = "d3"."d_date_sk"))
    LEFT JOIN {catalog}.{schema}.promotion ON ("cs_promo_sk" = "p_promo_sk"))
    LEFT JOIN {catalog}.{schema}.catalog_returns ON ("cr_item_sk" = "cs_item_sk")
       ...
       FROM
         (
          ...
          FROM
            ((({catalog}.{schema}.catalog_sales
          INNER JOIN {catalog}.{schema}.item ON ("i_item_sk" = "cs_item_sk"))
          INNER JOIN {catalog}.{schema}.date_dim ON ("d_date_sk" = "cs_sold_date_sk"))
          LEFT JOIN {catalog}.{schema}.catalog_returns ON ("cs_order_number" = "cr_order_number")
             AND ("cs_item_sk" = "cr_item_sk"))
    ...
    UNION       SELECT
          ...
          FROM
            ((({catalog}.{schema}.store_sales
          INNER JOIN {catalog}.{schema}.item ON ("i_item_sk" = "ss_item_sk"))
          INNER JOIN {catalog}.{schema}.date_dim ON ("d_date_sk" = "ss_sold_date_sk"))
          LEFT JOIN {catalog}.{schema}.store_returns ON ("ss_ticket_number" = "sr_ticket_number")
             AND ("ss_item_sk" = "sr_item_sk"))
          WHERE ("i_category" = 'Books')
    UNION       SELECT
            "d_year"
          ...
          FROM
            ((({catalog}.{schema}.web_sales
          INNER JOIN {catalog}.{schema}.item ON ("i_item_sk" = "ws_item_sk"))
          INNER JOIN {catalog}.{schema}.date_dim ON ("d_date_sk" = "ws_sold_date_sk"))
          LEFT JOIN {catalog}.{schema}.web_returns ON ("ws_order_number" = "wr_order_number")
    ...
    WITH
      ws AS (
       ...
       FROM
         (({catalog}.{schema}.web_sales
       LEFT JOIN {catalog}.{schema}.web_returns ON ("wr_order_number" = "ws_order_number")
          AND ("ws_item_sk" = "wr_item_sk"))
       INNER JOIN {catalog}.{schema}.date_dim ON ("ws_sold_date_sk" = "d_date_sk"))
    ...
    , cs AS (
       ...
       FROM
         (({catalog}.{schema}.catalog_sales
       LEFT JOIN {catalog}.{schema}.catalog_returns ON ("cr_order_number" = "cs_order_number")
          AND ("cs_item_sk" = "cr_item_sk"))
       INNER JOIN {catalog}.{schema}.date_dim ON ("cs_sold_date_sk" = "d_date_sk"))
    ...
    , ss AS (
       ...
       FROM
         (({catalog}.{schema}.store_sales
       LEFT JOIN {catalog}.{schema}.store_returns ON ("sr_ticket_number" = "ss_ticket_number")
          AND ("ss_item_sk" = "sr_item_sk"))
       INNER JOIN {catalog}.{schema}.date_dim ON ("ss_sold_date_sk" = "d_date_sk"))
    ...
    FROM
      (
       ...
       FROM
         ({catalog}.{schema}.store_sales
       LEFT JOIN {catalog}.{schema}.store_returns ON ("sr_item_sk" = "ss_item_sk")
    ...
    WHERE ("d_date" BETWEEN CAST('1999-2-01' AS DATE) AND (CAST('1999-2-01' AS DATE) + INTERVAL  '60' DAY))
       ...
       SELECT *
       FROM
         {catalog}.{schema}.web_returns wr1
